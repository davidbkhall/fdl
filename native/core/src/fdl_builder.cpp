...
ojson make_framing_intent(const char* id, const char* label,
    ...
    if (label) fi.insert_or_assign("label", label);
...
ojson make_context(const char* label, const char* context_creator) {
    ...
    if (label) ctx.insert_or_assign("label", label);
    if (context_creator) ctx.insert_or_assign("context_creator", context_creator);
...
ojson make_canvas(const char* id, const char* label, const char* source_canvas_id,
    ...
    if (label) c.insert_or_assign("label", label);
...
ojson make_framing_decision(const char* id, const char* label,
    ...
    if (label) fd.insert_or_assign("label", label);
...
ojson make_canvas_template(const char* id, const char* label,
    ...
    if (label) ct.insert_or_assign("label", label);
    ...
    ct.insert_or_assign("round", make_round_strategy(
        rounding_even_to_string(rounding.even),
        rounding_mode_to_string(rounding.mode)));
    return ct;
}
