# SPDX-FileCopyrightText: 2024-present ASC FDL Contributors
#
...
class MyFaultyHandler:
    ...
    def write_to_string(self, s: str, some_arg: str) -> str:
        return f"I went through all this trouble and all I got was this value: {some_arg} and this string: {s}"
