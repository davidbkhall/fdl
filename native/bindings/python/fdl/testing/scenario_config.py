...
class SourceVariant:
    ...
    expected_scaled_bounding_box : DimensionsFloat, optional
        Expected bbox after transform for unit tests.
    expected_content_translation : PointFloat, optional
        Expected content offset for unit tests.
...
def _make_scen1_variants() -> list[SourceVariant]:
    ...
    return [
        SourceVariant(
            ...
            fdl_basename="B_4448x3096_1x_FramingChart",
            input_dims=(4448.0, 3096.0),
            expected_scaled_bounding_box=DimensionsFloat(width=3840, height=2160),
            expected_content_translation=PointFloat(x=0.0, y=0.0),
            context_label="ARRI ALEXA Mini LF",
            canvas_label="4.5K LF Open Gate",
...
def _make_scen3_variants() -> list[SourceVariant]:
    ...
    return [
        SourceVariant(
            ...
            fdl_basename="D_8640x5760_1x_10PercentSafety-FramingChart",
            input_dims=(8640.0, 5760.0),
            expected_scaled_bounding_box=DimensionsFloat(width=4266, height=2400),
            expected_content_translation=PointFloat(x=0.0, y=0.0),
            context_label="Sony VENICE 2 8K",
            canvas_label="8.6K 3:2",
        ),
        SourceVariant(
            ...
            fdl_basename="E_8640x5760_1x_15PercentSafety-FramingChart",
            input_dims=(8640.0, 5760.0),
            expected_scaled_bounding_box=DimensionsFloat(width=4516, height=2540),
            expected_content_translation=PointFloat(x=0.0, y=0.0),
            context_label="Sony VENICE 2 8K",
            canvas_label="8.6K 3:2",
        ),
        SourceVariant(
            ...
            fdl_basename="F_8640x5760_1x_20PercentSafety-FramingChart",
            input_dims=(8640.0, 5760.0),
            expected_scaled_bounding_box=DimensionsFloat(width=4800, height=2700),
            expected_content_translation=PointFloat(x=0.0, y=0.0),
            context_label="Sony VENICE 2 8K",
            canvas_label="8.6K 3:2",
        ),
...
def _make_scen4_variants() -> list[SourceVariant]:
    ...
    return [
        SourceVariant(
            ...
            fdl_basename="D_8640x5760_1x_10PercentSafety-FramingChart",
            input_dims=(8640.0, 5760.0),
            expected_scaled_bounding_box=DimensionsFloat(width=4266, height=2844),
            expected_content_translation=PointFloat(x=0.0, y=0.0),
            context_label="Sony VENICE 2 8K",
            canvas_label="8.6K 3:2",
        ),
        SourceVariant(
            ...
            fdl_basename="E_8640x5760_1x_15PercentSafety-FramingChart",
            input_dims=(8640.0, 5760.0),
            expected_scaled_bounding_box=DimensionsFloat(width=4516, height=3010),
            expected_content_translation=PointFloat(x=0.0, y=0.0),
            context_label="Sony VENICE 2 8K",
            canvas_label="8.6K 3:2",
        ),
        SourceVariant(
            ...
            fdl_basename="F_8640x5760_1x_20PercentSafety-FramingChart",
            input_dims=(8640.0, 5760.0),
            expected_scaled_bounding_box=DimensionsFloat(width=4800, height=3200),
            expected_content_translation=PointFloat(x=0.0, y=0.0),
            context_label="Sony VENICE 2 8K",
            canvas_label="8.6K 3:2",
        ),
...
def _make_scen5_variants() -> list[SourceVariant]:
    ...
    return [
        SourceVariant(
            ...
            fdl_basename="A_4448x3096_1-3x_FramingChart",
            input_dims=(4448.0, 3096.0),
            expected_scaled_bounding_box=DimensionsFloat(width=4268, height=2400),
            expected_content_translation=PointFloat(x=0.0, y=0.0),
            context_label="ARRI ALEXA Mini LF",
            canvas_label="4.5K LF Open Gate",
        ),
...
def _make_scen6_variants() -> list[SourceVariant]:
    ...
    return [
        SourceVariant(
            ...
            fdl_basename="A_4448x3096_1-3x_FramingChart",
            input_dims=(4448.0, 3096.0),
            expected_scaled_bounding_box=DimensionsFloat(width=1920, height=2160),
            expected_content_translation=PointFloat(x=960.0, y=0.0),
            context_label="ARRI ALEXA Mini LF",
            canvas_label="4.5K LF Open Gate",
        ),
        SourceVariant(
...
def _make_scen9_variants() -> list[SourceVariant]:
    ...
    return [
        SourceVariant(
            ...
            fdl_basename="B_4448x3096_1x_FramingChart",
            input_dims=(4448.0, 3096.0),
            expected_scaled_bounding_box=DimensionsFloat(width=4266, height=2970),
            expected_content_translation=PointFloat(x=868.0, y=1016.0),
            context_label="ARRI ALEXA Mini LF",
            canvas_label="4.5K LF Open Gate",
        ),
        SourceVariant(
            ...
            fdl_basename="G_5040x3780_1x_TopAligned-FramingChart",
            input_dims=(5040.0, 3780.0),
            expected_scaled_bounding_box=DimensionsFloat(width=4266, height=3200),
            expected_content_translation=PointFloat(x=866.0, y=1301.0),
            context_label="RED V-RAPTOR 8K S35",
            canvas_label="7K 4:3 2x",
        ),
    ]
...
def _make_scen10_variants() -> list[SourceVariant]:
    ...
    return [
        SourceVariant(
            ...
            fdl_basename="B_4448x3096_1x_FramingChart",
            input_dims=(4448.0, 3096.0),
            expected_scaled_bounding_box=DimensionsFloat(width=4000, height=2250),
            expected_content_translation=PointFloat(x=0.0, y=0.0),
            context_label="ARRI ALEXA Mini LF",
            canvas_label="4.5K LF Open Gate",
        ),
        SourceVariant(
            ...
            fdl_basename="J_4320x3456_2x_FramingChart",
            input_dims=(4320.0, 3456.0),
            expected_scaled_bounding_box=DimensionsFloat(width=4000, height=1676),
            expected_content_translation=PointFloat(x=0.0, y=0.0),
            context_label="RED DSMC2 MONSTRO 8K VV",
            canvas_label="4.5K 5:4",
        ),
...
def _make_scen11_variants() -> list[SourceVariant]:
    ...
    return [
        SourceVariant(
            ...
            input_dims=(4448.0, 3096.0),
            expected_scaled_bounding_box=DimensionsFloat(width=3840, height=2160),
            expected_content_translation=PointFloat(x=1080.0, y=1420.0),
            context_label="ARRI ALEXA Mini LF",
            canvas_label="4.5K LF Open Gate",
        ),
        SourceVariant(
            ...
            fdl_basename="J_4320x3456_2x_FramingChart",
            input_dims=(4320.0, 3456.0),
            expected_scaled_bounding_box=DimensionsFloat(width=5156, height=2160),
            expected_content_translation=PointFloat(x=422.0, y=1420.0),
            context_label="RED DSMC2 MONSTRO 8K VV",
            canvas_label="4.5K 5:4",
        ),
    ]
...
def _make_scen14_variants() -> list[SourceVariant]:
    ...
    return [
        SourceVariant(
            ...
            input_dims=(8640.0, 5760.0),
            expected_scaled_bounding_box=DimensionsFloat(width=4266, height=2400),
            expected_content_translation=PointFloat(x=-134.0, y=-120.0),
            context_label="Sony VENICE 2 8K",
            canvas_label="8.6K 3:2",
        ),
        SourceVariant(
            ...
            input_dims=(8640.0, 5760.0),
            expected_scaled_bounding_box=DimensionsFloat(width=4516, height=2540),
            expected_content_translation=PointFloat(x=-258.0, y=-190.0),
            context_label="Sony VENICE 2 8K",
            canvas_label="8.6K 3:2",
        ),
        SourceVariant(
            ...
            input_dims=(8640.0, 5760.0),
            expected_scaled_bounding_box=DimensionsFloat(width=4800, height=2700),
            expected_content_translation=PointFloat(x=-400.0, y=-270.0),
            context_label="Sony VENICE 2 8K",
            canvas_label="8.6K 3:2",
        ),
    ]
...
def _make_scen17_variants() -> list[SourceVariant]:
    ...
    return [
        SourceVariant(
            ...
            input_dims=(4448.0, 3096.0),
            expected_scaled_bounding_box=DimensionsFloat(width=3840, height=2160),
            expected_content_translation=PointFloat(x=0.0, y=1840.0),
            context_label="ARRI ALEXA Mini LF",
            canvas_label="4.5K LF Open Gate",
        ),
        SourceVariant(
...
def _make_scen18_variants() -> list[SourceVariant]:
    ...
    return [
        SourceVariant(
            ...
            fdl_basename="A_4448x3096_1-3x_FramingChart",
            input_dims=(4448.0, 3096.0),
            expected_scaled_bounding_box=DimensionsFloat(width=2134, height=2400),
            expected_content_translation=PointFloat(x=854.0, y=-120.0),
            context_label="ARRI ALEXA Mini LF",
            canvas_label="4.5K LF Open Gate",
        ),
        SourceVariant(
    ...
    12: ScenarioConfig(
        ...
        variants=[
            SourceVariant(
                ...
                fdl_basename="D_8640x5760_1x_10PercentSafety-FramingChart",
                input_dims=(8640.0, 5760.0),
                expected_scaled_bounding_box=DimensionsFloat(width=1920, height=1080),
                expected_content_translation=PointFloat(x=-484.0, y=0.0),
                context_label="Sony VENICE 2 8K",
                canvas_label="8.6K 3:2",
            ),
        ],
    ...
    13: ScenarioConfig(
        ...
        variants=[
            SourceVariant(
                ...
                fdl_basename="D_8640x5760_1x_10PercentSafety-FramingChart",
                input_dims=(8640.0, 5760.0),
                expected_scaled_bounding_box=DimensionsFloat(width=1920, height=1280),
                expected_content_translation=PointFloat(x=-484.0, y=-100.0),
                context_label="Sony VENICE 2 8K",
                canvas_label="8.6K 3:2",
            ),
        ],
    ...
    19: ScenarioConfig(
        ...
        variants=[
            SourceVariant(
                ...
                fdl_basename="Test_06_RED_EPIC_Dragon_6K",
                input_dims=(4096.0, 2048.0),
                expected_scaled_bounding_box=DimensionsFloat(width=7262, height=1816),
                expected_content_translation=PointFloat(x=-630.0, y=1593.0),
                context_label="RED EPIC DRAGON 6K S35",
                canvas_label="4K 2:1",
    ...
    20: ScenarioConfig(
        ...
        variants=[
            SourceVariant(
                ...
                fdl_basename="Test_01_Sony_FX3",
                input_dims=(3840.0, 2160.0),
                expected_scaled_bounding_box=DimensionsFloat(width=4266, height=1816),
                expected_content_translation=PointFloat(x=-134.0, y=0.0),
                context_label="Sony FX3",
                canvas_label="4K",
    ...
    23: ScenarioConfig(
        ...
        variants=[
            SourceVariant(
                ...
                fdl_basename="Test_09_Blackmagic_URSA_Cine_17K_65",
                input_dims=(12288.0, 6912.0),
                expected_scaled_bounding_box=DimensionsFloat(width=1998, height=1124),
                expected_content_translation=PointFloat(x=-562.0, y=0.0),
                context_label="Blackmagic Design URSA Cine 17K 65",
                canvas_label="12K 16:9",
    ...
    24: ScenarioConfig(
        ...
        variants=[
            SourceVariant(
                ...
                fdl_basename="Test_19_ARRI_Alexa_65",
                input_dims=(6580.0, 5020.0),
                expected_scaled_bounding_box=DimensionsFloat(width=4266, height=2258),
                expected_content_translation=PointFloat(x=-132.0, y=-48.0),
                context_label="ARRI Alexa 65",
                canvas_label="6500",
    ...
    25: ScenarioConfig(
        ...
        variants=[
            SourceVariant(
                ...
                fdl_basename="Test_20_ARRI_Alexa_65",
                input_dims=(6580.0, 5020.0),
                expected_scaled_bounding_box=DimensionsFloat(width=2376, height=1814),
                expected_content_translation=PointFloat(x=-940.0, y=0.0),
                context_label="ARRI Alexa 65",
                canvas_label="6500",
                test_name_suffix="arri_alexa_65",
            ),
    ...
    26: ScenarioConfig(
        ...
        variants=[
            SourceVariant(
                ...
                fdl_basename="Test_58_Blackmagic_URSA_Cine_12K_LF_CustomFraming",
                input_dims=(12288.0, 6912.0),
                expected_scaled_bounding_box=DimensionsFloat(width=10324, height=2160),
                expected_content_translation=PointFloat(x=-2162.0, y=1420.0),
                context_label="Blackmagic URSA Cine 12K LF",
                canvas_label="12K 16:9",
    ...
    27: ScenarioConfig(
        ...
        variants=[
            SourceVariant(
                ...
                fdl_basename="Test_60_RED_EPIC_Dragon_6K_CustomFraming",
                input_dims=(4096.0, 2048.0),
                expected_scaled_bounding_box=DimensionsFloat(width=7614, height=2160),
                expected_content_translation=PointFloat(x=-807.0, y=1420.0),
                context_label="RED EPIC Dragon 6K",
                canvas_label="4K 2:1",
                test_name_suffix="red_epic_dragon_6k",
            ),
    ...
    28: ScenarioConfig(
        ...
        variants=[
            SourceVariant(
                ...
                fdl_basename="Test_62_ARRI_Alexa_65_CustomFraming",
                input_dims=(6580.0, 5020.0),
                expected_scaled_bounding_box=DimensionsFloat(width=6736, height=2160),
                expected_content_translation=PointFloat(x=-368.0, y=1420.0),
                context_label="ARRI Alexa 65",
                canvas_label="6500",
                test_name_suffix="arri_alexa_65",
            ),
    ...
    29: ScenarioConfig(
        ...
        variants=[
            SourceVariant(
                ...
                fdl_basename="Test_01_Sony_FX3",
                input_dims=(3840.0, 2160.0),
                expected_scaled_bounding_box=DimensionsFloat(width=2880, height=1080),
                expected_content_translation=PointFloat(x=-1274.0, y=0.0),
                context_label="Sony FX3",
                canvas_label="4K",
                test_name_suffix="sony_fx3",
            ),
    ...
    31: ScenarioConfig(
        ...
        variants=[
            SourceVariant(
                ...
                fdl_basename="combo_src_topleft_tpl_topcenter_source",
                input_dims=(4096.0, 3072.0),
                expected_scaled_bounding_box=DimensionsFloat(width=4416, height=2484),
                expected_content_translation=PointFloat(x=0.0, y=0.0),
                context_label="Off-Center Source top-left",
                canvas_label="4K Canvas - Source top-left",
    ...
    32: ScenarioConfig(
        ...
        variants=[
            SourceVariant(
                ...
                expected_scaled_bounding_box=DimensionsFloat(width=3934, height=2254),
                expected_content_translation=PointFloat(x=556.0, y=2316.0),
