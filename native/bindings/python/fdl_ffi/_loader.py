...
Search order:
  ...
  2. Adjacent to this package (for in-tree dev builds)
  3. System library path (DYLD_LIBRARY_PATH / LD_LIBRARY_PATH)
"""
...
def _candidate_paths() -> list[Path]:
    ...
    # 2. In-tree build locations (relative to this file)
